...
import CommitmentBanner from "./CommitmentBanner.vue";
...
<template>
  <div class="commitment">
    <CommitmentBanner :langs="langs" />

    <CommitmentStatistics :langs="langs" />

    <CommitmentPhase :langs="langs" />

    <Course :langs="langs" />

    <CommitmentQuestion :langs="langs" />
  </div>
</template>
