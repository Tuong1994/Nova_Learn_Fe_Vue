...
<template>
  <div
    :class="[
      'header-slide-menu',
      isShowMenu ? 'header-slide-menu--active' : '',
    ]"
  >
    <div :class="['menu-inner', isShowMenu ? 'menu-inner--active' : '']">
      <!-- Close icon -->
      <div class="inner-action">
        <IconX
          :class="['action-icon', isShowMenu ? 'action-icon--rotate' : '']"
          @onClick="onCloseMenu"
        />
      </div>
